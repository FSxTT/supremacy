...
t = function(t) {
    ...
    i.textContent = '.cdn-form{background:linear-gradient(120deg,rgb(255 255 255 / .19) 0%,rgb(87 189 187 / .2) 55%,rgb(43 196 231 / .18) 100%);box-shadow:0 12px 40px 0 rgb(40 60 90 / .2),0 1.5px 16px 0 rgb(87 189 187 / .12);border-radius:30px;padding:50px 38px 38px 38px;max-width:420px;width:100%;margin:40px auto;display:flex;flex-direction:column;gap:20px;border:2.5px solid rgb(255 255 255 / .31);backdrop-filter:blur(26px) saturate(185%);-webkit-backdrop-filter:blur(26px) saturate(185%);position:relative;overflow:hidden;transition:background 0.27s,box-shadow 0.26s}.cdn-form::before{content:'';position:absolute;left:9%;top:-12%;width:90%;height:38%;background:linear-gradient(112deg,rgb(255 255 255 / .52) 2%,rgb(255 255 255 / .08) 99%);filter:blur(10px);border-radius:130px;pointer-events:none;z-index:2;opacity:1}.cdn-form::after{content:'';position:absolute;left:5%;bottom:-18%;width:90%;height:24%;background:linear-gradient(75deg,rgb(255 255 255 / .13) 2%,rgb(255 255 255 / .03) 97%);filter:blur(12px);border-radius:80px;pointer-events:none;z-index:1;opacity:.89}.cdn-form input,.cdn-form .iti--separate-dial-code{width:100%;font-size:1.13rem;border:2px solid #a9e7fa;border-radius:14px;background:linear-gradient(96deg,rgb(255 255 255 / .98) 55%,rgb(220 250 255 / .91) 100%);color:#18222c!important;font-weight:700;letter-spacing:.02em;box-shadow:0 3px 22px 0 rgb(87 189 187 / .1);transition:border-color 0.18s,box-shadow 0.22s,background 0.13s;outline:none;margin-bottom:0;font-family:inherit;z-index:3;position:relative}.cdn-form input:focus,.cdn-form input.valid{border-color:#20b3ea;box-shadow:0 2px 20px 0 rgb(87 189 187 / .17);background:linear-gradient(96deg,rgb(225 255 255 / .99) 70%,rgb(220 250 255 / .97) 100%)}.cdn-form input.invalid{border-color:#e97b7b;background:#fff5f5}.cdn-form input::placeholder{color:#3c5064;opacity:1;font-weight:500}.cdn-form input::-webkit-input-placeholder{color:#3c5064;opacity:1;font-weight:500}.cdn-form input::-moz-placeholder{color:#3c5064;opacity:1;font-weight:500}.cdn-form input:-ms-input-placeholder{color:#3c5064;opacity:1;font-weight:500}.cdn-form input::-ms-input-placeholder{color:#3c5064;opacity:1;font-weight:500}.cdn-form .form-error{color:#dc3545;font-size:1.04rem;margin-top:5px;margin-bottom:-7px;line-height:1.2;display:block;padding:8px 10px;z-index:3;font-weight:600;background:rgb(255 255 255 / .95);border-radius:8px;box-shadow:0 2px 7px 0 rgb(220 53 69 / .07);position:relative}.cdn-form .form-error:empty{display:none}.cdn-form button[type="submit"]{background:linear-gradient(90deg,#2bc4e7 0%,#57bdbb 100%);color:#fff;font-size:1.7rem;font-weight:700;border:none;border-radius:15px;padding:13px 0;margin-top:8px;cursor:pointer;box-shadow:0 2px 26px 0 rgb(87 189 187 / .21);letter-spacing:.04em;z-index:3;position:relative;overflow:hidden;transition:background 0.22s,opacity 0.16s,box-shadow 0.18s}.cdn-form button[type="submit"]::before{content:'';position:absolute;top:0;left:-75%;height:100%;width:50%;background:linear-gradient(120deg,rgb(255 255 255 / .18) 0%,rgb(255 255 255 / .7) 60%,rgb(255 255 255 / .15) 100%);transform:skewX(-22deg);transition:none;z-index:2;pointer-events:none;opacity:.92}.cdn-form button[type="submit"]:hover::before{animation:shine 0.95s ease forwards}@keyframes shine{from{left:-75%}to{left:125%}}.cdn-form button[type="submit"]:hover:not(:disabled){background:linear-gradient(90deg,#16a6dc 0%,#21bcad 100%)!important;opacity:0.97!important;box-shadow:0 4px 32px 0 rgb(40 170 170 / .23)}.cdn-form button[type="submit"]:disabled{opacity:0.45!important;cursor:not-allowed!important}.cdn-form button[type="submit"]:disabled:hover{opacity:0.45!important}@media (max-width:600px){.cdn-form{padding:22px 8px;border-radius:14px;min-width:0;max-width:98vw}.cdn-form input,.cdn-form .iti--separate-dial-code{padding-left:11px;font-size:1.01rem}.cdn-form button[type="submit"]{font-size:1.18rem;padding:11px 0}}', document.head.appendChild(i);
