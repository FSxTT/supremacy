...
function e(t, i, e, a = "Name") {
    ...
    * {
    ...
    .lds-spinner-yYhkgJucat div:after {
      ...
      height: 18px;
      border-radius: 3px;
      background: linear-gradient(180deg, #57bdbb 60%, #fff 100%);
      opacity: 0.95;
    }
    ...
    .cdn-form {
      background: #fff;
      box-shadow: 0 8px 32px 0 rgba(40,60,90,0.12);
      border-radius: 22px;
    ...
    .cdn-form .iti--separate-dial-code {
      ...
      background: #f9fbfc;
      color: #23243a;
      transition: border-color 0.23s, box-shadow 0.23s, background 0.22s;
      outline: none;
      margin-bottom: 0;
      font-family: inherit;
    }
    ...
    .cdn-form input.valid {
      border-color: #57bdbb;
      box-shadow: 0 2px 10px 0 rgba(87,189,187,0.09);
      background: #f6ffff;
    }
    ...
    .cdn-form button[type="submit"] {
      ...
      margin-top: 8px;
      cursor: pointer;
      box-shadow: 0 2px 16px 0 rgba(87,189,187,0.10);
      transition: background 0.16s, opacity 0.16s;
      letter-spacing: 0.04em;
    }
    
    .cdn-form button[type="submit"]:hover:not(:disabled) {
      background: linear-gradient(90deg, #22aac3 0%, #1ebfb6 100%);
      opacity: 0.93;
    }
    ...
    .iti__country-list {
      ...
      box-shadow: 0 4px 24px 0 rgba(80,80,120,0.15) !important;
      font-size: 1.03rem;
    }
